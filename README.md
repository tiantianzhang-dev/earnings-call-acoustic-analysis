...
**The thesis can be found here**: [Exploratory Analysis of Correlation between Earnings Call Acoustic Features and Credit Ratings: A FinBERT Validation Approach](https://campus-fryslan.studenttheses.ub.rug.nl/682/)
